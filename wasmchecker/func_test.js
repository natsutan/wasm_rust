fetch("./func_test.wasm").then(response => 
    response.arrayBuffer()
        ...
        console.debug("Uncrowned white", instance.exports.withoutCrown(crowned_white));
        console.debug("Uncrowned black", instance.exports.withoutCrown(crowned_black));
        console.debug("Crown is crowned", instance.exports.isCrowned(crowned_black));
        console.debug("Crown is crowned", instance.exports.isCrowned(crowned_white));
